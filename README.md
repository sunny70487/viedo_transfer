...
支援從 URL（YouTube、Bilibili 等）或本地上傳，並以資料夾管理任務列表；可即時查看轉錄進度、預覽字幕。

![主畫面](docs/images/main.png)

### 字幕編輯器

轉錄完成後可進入字幕編輯器：影片同步播放、點擊字幕跳轉時間、AI 增強、匯出多種格式，並支援搜尋、分割、合併等操作。

![字幕編輯器](docs/images/editor.png)
